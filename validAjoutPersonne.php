...
$res=ajoutPersonne($nom,$prenom,$dateNaiss,$numero,$rue,$codePostal,$ville,$pdo);

if($res=="OK"){
  
echo "<h3><img src='images-gym/check.png'>L'adhérent a bien été inséré dans la BDD!</h3>";
}
else {
